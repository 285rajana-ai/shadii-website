            ...
            <div className="site-shell">
                <div className="grid gap-12 lg:grid-cols-[1.15fr_repeat(3,minmax(0,1fr))]">
                    <div>
                        ...
                        <div className="mt-6 flex flex-wrap gap-3 text-xs font-semibold uppercase tracking-[0.18em] text-white/42">
                            <span className="rounded-full border border-white/10 px-3 py-2">CNIC Verified</span>
                            <span className="rounded-full border border-white/10 px-3 py-2">Private Messaging</span>
                            <span className="rounded-full border border-white/10 px-3 py-2">Family Friendly</span>
                        </div>
                    </div>

                    {columns.map((column) => (
                        <div key={column.title}>
                            <div className="text-[11px] font-bold uppercase tracking-[0.26em] text-[#e0b562]">
                                {column.title}
                            </div>
                ...
                <div className="mt-12 flex flex-col gap-4 border-t border-white/8 pt-6 text-xs text-white/38 sm:flex-row sm:items-center sm:justify-between">

...
export function Navbar() {
    ...
    return (
        <header className="fixed inset-x-0 top-0 z-50 liquid-glass liquid-glass-glow h-20 flex items-center border-b border-[var(--line)] w-full">
            <div className="site-shell w-full flex items-center justify-between gap-4">
            ...
            {open && (
                <div className="menu-panel absolute top-20 left-0 w-full bg-white p-4 shadow-2xl backdrop-blur-2xl lg:hidden border-b border-[var(--line)]">

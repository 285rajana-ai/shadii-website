...
export function Footer() {
    ...
    return (
        <footer className="section pb-16 pt-8 bg-transparent border-0">
            <div className="site-shell">
                <div className="liquid-glass liquid-glass-glow p-8 md:p-12 shadow-2xl relative overflow-hidden">
